...
object Kernel {
  ...
  def contractParametersPrefs(): Unit = {
    ...
    // Общее
    //
    /*  1 */ ContractParametersPref.create(pt = 1, title = "Логин", sort = 1, script = "", history = true, flags = 1, lm = now)
    /*  2 */ ContractParametersPref.create(pt = 1, title = "Лицевой счёт", sort = 1, script = "", history = true, flags = 1, lm = now)
    /*  3 */ ContractParametersPref.create(pt = 2, title = "Адрес подключения", sort = 1, script = "", history = true, flags = 1, lm = now)
    /*  4 */ ContractParametersPref.create(pt = 9, title = "Телефон", sort = 1, script = "", history = true, flags = 1, lm = now)
    /*  5 */ ContractParametersPref.create(pt = 3, title = "Email", sort = 1, script = "", history = true, flags = 1, lm = now)

    // Физ. лица
    //
    /*  6 */ ContractParametersPref.create(pt = 1, title = "Фамилия", sort = 1, script = "", history = true, flags = 1, lm = now)
    /*  7 */ ContractParametersPref.create(pt = 1, title = "Имя", sort = 1, script = "", history = true, flags = 1, lm = now)
    /*  8 */ ContractParametersPref.create(pt = 1, title = "Отчество", sort = 1, script = "", history = true, flags = 1, lm = now)
    /*  9 */ ContractParametersPref.create(pt = 7, title = "Удостоверение личности: тип", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 10 */ ContractParametersPref.create(pt = 1, title = "Удостоверение личности: серия", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 11 */ ContractParametersPref.create(pt = 1, title = "Удостоверение личности: номер", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 12 */ ContractParametersPref.create(pt = 6, title = "Удостоверение личности: дата", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 13 */ ContractParametersPref.create(pt = 1, title = "Удостоверение личности: код подразделения", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 14 */ ContractParametersPref.create(pt = 1, title = "Удостоверение личности: название подразделения", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 15 */ ContractParametersPref.create(pt = 1, title = "Адрес регистрации", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 16 */ ContractParametersPref.create(pt = 6, title = "Дата рождения", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 17 */ ContractParametersPref.create(pt = 1, title = "Место рождения", sort = 1, script = "", history = true, flags = 1, lm = now)

    // Юр. лица
    //
    /* 18 */ ContractParametersPref.create(pt = 1, title = "Название", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 19 */ ContractParametersPref.create(pt = 1, title = "Адрес юридический", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 20 */ ContractParametersPref.create(pt = 5, title = "Бюджет", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 21 */ ContractParametersPref.create(pt = 1, title = "ИНН", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 22 */ ContractParametersPref.create(pt = 1, title = "Адрес для выставления счетов", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 23 */ ContractParametersPref.create(pt = 1, title = "КПП", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 24 */ ContractParametersPref.create(pt = 1, title = "ОГРН", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 25 */ ContractParametersPref.create(pt = 1, title = "ОКАТО", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 26 */ ContractParametersPref.create(pt = 1, title = "ОКТМО", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 27 */ ContractParametersPref.create(pt = 1, title = "ОКВЭД", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 28 */ ContractParametersPref.create(pt = 1, title = "ОКПО", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 29 */ ContractParametersPref.create(pt = 1, title = "Банк: БИК", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 30 */ ContractParametersPref.create(pt = 1, title = "Банк: название", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 31 */ ContractParametersPref.create(pt = 1, title = "Банк: К/С", sort = 1, script = "", history = true, flags = 1, lm = now)
    /* 32 */ ContractParametersPref.create(pt = 1, title = "Банк: Р/С", sort = 1, script = "", history = true, flags = 1, lm = now)
  }
