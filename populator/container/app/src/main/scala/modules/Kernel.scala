...
object Kernel {
  ...
  def contractParametersPrefs(): Unit = {
    ...
    // Физ. лица
    //
    /*  6 */ ContractParametersPref.create(pt = 1, title = "Фамилия", sort = 1, script = "", flags = 5, lm = now)
    /*  7 */ ContractParametersPref.create(pt = 1, title = "Имя", sort = 1, script = "", flags = 5, lm = now)
    /*  8 */ ContractParametersPref.create(pt = 1, title = "Отчество", sort = 1, script = "", flags = 5, lm = now)
    ...
    /* 32 */ ContractParametersPref.create(pt = 1, title = "Банк: Р/С", sort = 1, script = "", flags = 5, lm = now)
  ...
  def contractParameterGroups(): Unit = {
    ...
    ContractParameterGroup.create(gid = 1, pid = 33)
    ContractParameterGroup.create(gid = 1, pid = 34)
  ...
  def contractStatuses(): Unit = {
    ContractActions.changeStatus(Seq(100), 0, new DateTime(2018, 12, 1, 9, 20))
  }
