...
object Kernel {
  ...
  def contractComments(): Unit = {
    ContractComment.create(cid = 1, uid = 1, subject = "Комплексный фторид церия как электронное облако", comment =
      """
    ...
    ContractComment.create(cid = 1, uid = 1, subject = "Плазменный газ: основные моменты", comment =
      """
    ...
    ContractComment.create(cid = 2, uid = 1, subject = "Стремящийся интеграл Гамильтона: гипотеза и теории", comment =
      """
    ...
    ContractComment.create(cid = 2, uid = 1, subject = "Почему неравномерен параллакс?", comment =
      """
